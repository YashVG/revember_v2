...
export function PlannerPage({ snapshot, onSnapshot, onStartSession }: {
  ...
  return <div className="planner-page">
    <header className="planner-heading"><div><Eyebrow>Study windows</Eyebrow><h1>Plan</h1><p>Set the deadline. Revember keeps each card’s own evidence-based due date intact.</p></div><button className="primary" onClick={() => { setEditing(undefined); setCreating(true); }}><Plus /> New exam</button></header>
